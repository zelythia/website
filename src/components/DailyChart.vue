      ...
      options: {
        ...
        scales: {
          ...
          y: {
            ...
            max: 100000,
            ticks: {
              values: [50, 100, 200, 500, 1000, 10000, 50000, 100000],
            },
            grid: {
              drawTicks: true,
              drawBorder: true,
            ...
            afterBuildTicks: function (axis) {
              ...
              const tickValues = [50, 100, 200, 500, 1000, 10000, 50000, 100000];
    ...
    async fetchCSV(path) {
      ...
      for (let i = 1; i < dataRows.length; i++) {
        ...
        for (let j = 1; j < headers.length; j++) {
          values.push(parseInt(dataRows[i][j].trim()) - parseInt(dataRows[i-1][j].trim()));
        }
        d.set(dataRows[i][0].trim(), values);
      }
